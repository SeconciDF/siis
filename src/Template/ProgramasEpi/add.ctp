...
<div class="navbar nopadding">
    <div class="navbar-inner nopadding">
       <ul class="nav">
          ...
          <li class="active"><?php echo $this->Html->link('EPI Existente', ['controller' => 'ProgramasEpi', 'action' => 'index', $programa['id']], ['escape'=>false]); ?></li>
...
<p>
    <label>Certificado de aprova&ccedil;&atilde;o</label>
    <span class="field">
        <?php echo $this->Form->input('certificado_aprovacao', ['label' => false, 'type' => 'text', 'required' => true, 'class' => 'input-medium' ]); ?>
    </span>
</p>
<p>
    <label>Atenua&ccedil;&atilde;o / fator de prote&ccedil;&atilde;o</label>
    <span class="field">
        <?php echo $this->Form->input('atenuacao', ['label' => false, 'type' => 'text', 'required' => true, 'class' => 'input-large' ]); ?>
    </span>
</p>
<p>
    <label>Eficaz</label>
