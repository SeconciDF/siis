...
class ProgramasEpiController extends AppController {
  ...
  public function index($id = null) {
    ...
    $this->paginate = [
      'conditions' => [
        'ProgramasEpi.programas_id' => $programa['id']
      ],
      'fields' => [
        'ProgramasEpi.id',
      ...
      'join' => [
        [
          ...
          'alias' => 'a',
          'type' => 'INNER',
          'conditions' => 'a.id = ProgramasEpi.ambientes_id',
        ],
        [
        ...
        [
          ...
          'alias' => 'Grupo',
          'type' => 'INNER',
          'conditions' => 'Grupo.id = ProgramasEpi.ambientes_grupos_id',
        ],
        [
        ...
        [
          ...
          'alias' => 'Perigo',
          'type' => 'INNER',
          'conditions' => 'Perigo.id = ProgramasEpi.perigos_danos_id',
        ],
        [
      ...
      'group' => ['ProgramasEpi.id'],
      'order' => ['Ambiente.descricao' => 'ASC', 'Grupo.nome' => 'ASC']
    ];

    $this->set('programa', $programa);
    $this->set('medidas', $this->paginate($this->ProgramasEpi));
  }
  ...
  public function add($id = null) {
    ...
    $entity = $this->ProgramasEpi->newEntity();
    if ($this->request->is('post')) {
      $entity = $this->ProgramasEpi->patchEntity($entity, $this->request->data);
      if ($this->ProgramasEpi->save($entity)) {
  ...
  public function edit($id = null) {
    ...
    $entity = $this->ProgramasEpi->get($id);
  ...
  public function delete($id) {
    ...
    $entity = $this->ProgramasEpi->get($id);
    if ($this->ProgramasEpi->delete($entity)) {
