...
<div class="widgetcontent bordered shadowed nopadding">
  ...
  <p>
      ...
      <span class="field">
          <?php echo $this->Form->input('funcoes', ['label' => false, 'type' => 'select', 'required' => false, 'class' => 'input-xxlarge chzn-select', 'multiple' => 'multiple', 'data-placeholder'=>'Selecione os itens', 'empty' => true, 'options' => $funcoes]); ?>
      </span>
  </p>
  <p>
      <label>Empresa</label>
      <span class="field">
          <?php echo $this->Form->input('empresas', ['label' => false, 'type' => 'select', 'required' => false, 'class' => 'input-xxlarge chzn-select', 'multiple' => 'multiple', 'data-placeholder'=>'Selecione os itens', 'empty' => true, 'options' => $empresas]); ?>
      </span>
  </p>
