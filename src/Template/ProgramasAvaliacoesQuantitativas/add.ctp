...
<p>
    <label>GHE</label>
    <span class="field">
        <?php echo $this->Form->input('ghe', ['label' => false, 'type' => 'select', 'empty' => true, 'required' => true, 'class' => 'input-xxlarge chzn-select', 'multiple' => 'multiple', 'data-placeholder'=>'Selecione os itens', 'options' => $grupos]); ?>
    </span>
</p>
<p>
    <label>Trabalhador</label>
    <span class="field">
        <?php echo $this->Form->input('beneficiarios_id', ['label' => false, 'type' => 'select', 'empty' => true, 'required' => false, 'class' => 'input-xxlarge', 'options' => $beneficiarios]); ?>
    </span>
</p>
<p>
