  ...
  <table class="table table-bordered">
      <thead>
          <tr>
            ...
            <th><?= $this->Paginator->sort('ProgramasPlanosAcoes.acoes_necessarias', 'A&ccedil;&otilde;es necess&aacute;rias', ['escape' => false]); ?></th>
            <th><?= $this->Paginator->sort('ProgramasPlanosAcoes.monitoracao', 'Monitora&ccedil;&atilde;o', ['escape' => false]); ?></th>
      ...
      <tbody  style="background: #fff;">
          ...
          <tr>
              ...
              <td><?= h($medida['acoes_necessarias']); ?></td>
              <td><?= h($medida['monitoracao']); ?></td>
