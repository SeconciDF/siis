...
<div class="widgetcontent bordered shadowed nopadding">
  ...
  <p>
      ...
      <span class="field">
          <?php echo $this->Form->input('processos', ['label' => false, 'type' => 'select', 'required' => false, 'class' => 'input-xxlarge chzn-select', 'multiple' => 'multiple', 'data-placeholder'=>'Selecione os itens', 'empty' => true, 'options' => $processos]); ?>
      </span>
  </p>
  <p>
