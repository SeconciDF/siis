...
class ProgramasMedidasControlesController extends AppController {
  ...
  public function index($id = null) {
    ...
    $this->paginate = [
      'conditions' => [
        'ProgramasMedidasControles.programas_id' => $programa['id']
      ],
      'fields' => [
      ...
      'join' => [
        [
          ...
          'alias' => 'a',
          'type' => 'INNER',
          'conditions' => 'a.id = ProgramasMedidasControles.ambientes_id',
        ],
        [
        ...
        [
          ...
          'alias' => 'Grupo',
          'type' => 'INNER',
          'conditions' => 'Grupo.id = ProgramasMedidasControles.ambientes_grupos_id',
        ],
        [
        ...
        [
          ...
          'alias' => 'Perigo',
          'type' => 'INNER',
          'conditions' => 'Perigo.id = ProgramasMedidasControles.perigos_danos_id',
        ],
        [
      ...
      'group' => ['ProgramasMedidasControles.id'],
      'order' => ['Ambiente.descricao' => 'ASC', 'Grupo.nome' => 'ASC']
    ];

    $this->set('programa', $programa);
    $this->set('medidas', $this->paginate($this->ProgramasMedidasControles));
  }
  ...
  public function add($id = null) {
    ...
    $entity = $this->ProgramasMedidasControles->newEntity();
    if ($this->request->is('post')) {
      $entity = $this->ProgramasMedidasControles->patchEntity($entity, $this->request->data);
      if ($this->ProgramasMedidasControles->save($entity)) {
  ...
  public function edit($id = null) {
    ...
    $entity = $this->ProgramasMedidasControles->get($id);
  ...
  public function delete($id) {
    ...
    $entity = $this->ProgramasMedidasControles->get($id);
    if ($this->ProgramasMedidasControles->delete($entity)) {
