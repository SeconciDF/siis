...
<?php
    ...
    echo $this->Form->create($jornada, ['class' => 'stdform stdform2']);
?>
<p>
    <label>Empresa</label>
    <span class="field">
...
<p>
    <label>Turno</label>
    <span class="field">
        <?php echo $this->Form->input('turno', ['label' => false, 'type' => 'text', 'required' => true, 'class' => 'input-large']); ?>
    </span>
</p>
<p>
    <label>Horas semanais</label>
    <span class="field">
        <?php echo $this->Form->input('horas', ['label' => false, 'type' => 'number', 'required' => true, 'class' => 'input-small' ]); ?>
    </span>
</p>
