...
<div class="navbar nopadding">
    <div class="navbar-inner nopadding">
       <ul class="nav">
          ...
          <li class="active"><?php echo $this->Html->link('Perfil da Exposi&ccedil;&atilde;o Existente', ['controller' => 'ProgramasPerfilExposicoes', 'action' => 'index', $programa['id']], ['escape'=>false]); ?></li>
...
<p>
    ...
    <span class="field">
        <?php echo $this->Form->input('apoio_exposicoes_id', ['label' => false, 'type' => 'select', 'empty' => true, 'required' => true, 'class' => 'input-xlarge', 'options' => $exposicoes]); ?>
    </span>
</p>
<p>
    <label>T&eacute;cnica utilizada</label>
    <span class="field">
        <?php echo $this->Form->input('tecnica_utilizada', ['label' => false, 'type' => 'textarea', 'required' => true, 'class' => 'input-xxlarge' ]); ?>
    </span>
</p>
<p>
    <label>Intensidade</label>
    <span class="field">
        <?php echo $this->Form->input('intensidade', ['label' => false, 'type' => 'text', 'required' => true, 'class' => 'input-large' ]); ?>
    </span>
</p>
