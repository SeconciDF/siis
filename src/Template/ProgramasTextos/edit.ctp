...
<div class="mediamgr_head">
    <ul class=" mediamgr_menu">
        ...
        <li class="marginleft15">
            <?php echo $this->Html->link('<span class="icon-edit"></span> Novo', ['action' => 'add', $programa['id']], ['class' => 'btn selectall', 'escape'=>false]) ?>
        </li>
    </ul>
...
<p>
    <label>Tipo</label>
    <span class="field">
        <?php echo $this->Form->input('tipo', ['label' => false, 'type' => 'select', 'empty' => true, 'required' => true, 'class' => 'input-medium', 'options' => $tipos, 'escape' => false ]); ?>
