...
<?php
    ...
    echo $this->Form->create($processo, ['class' => 'stdform stdform2']);
...
<p>
    ...
    <span class="field">
        <?php echo $this->Form->input('sequencia', ['label' => false, 'type' => 'number', 'required' => true, 'class' => 'input-small' ]); ?>
    </span>
</p>
<p>
    <label>Processo</label>
    <span class="field">
        <?php echo $this->Form->input('processo', ['label' => false, 'type' => 'text', 'required' => true, 'class' => 'input-xxlarge' ]); ?>
    </span>
</p>
<p>
